...
const Topbar = () => {
  return (
    <div className="bg-rabbit-red text-indigo-900">
      <div className="container mx-auto flex justify-between items-center py-3 px-4">
        <div className="hidden md:flex items-center space-x-4">
          ...
          <a href="https://x.com/" target="_blank" className="hover:text-gray-300">
            <RiTwitterXLine className="h-4 w-4" />
          </a>
        </div>
        <div className="text-[15px] text-center flex-grow">
